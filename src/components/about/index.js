  ...
  render() {
    return <div className={'uk-container'}>
      <div className={'uk-margin-large-top'}>
        ...
        <p><span className={'primary-color'}>Indian Institution of Information Technology</span> Vadodara (IIIT-V) is
          ...
          Management Institute, Gujarat State Fertilizers and Chemicals and Tata Consultancy Services.</p>
        <p><span className={'primary-color'}>Cerebro</span> is the <span className={'primary-color'}>Annual Technical Festival</span> of
          ...
          It is entirely organized by the <span className={'primary-color'}>Technical Society of IIIT</span>, Vadodara
